...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('transactions', function (Blueprint $table) {
            ...
            $table->foreignId('employer_id')->constrained()->onDelete('cascade'); // معرف الموظف الذي قام بالحركة
            $table->foreignId('supplier_id')->nullable()->constrained()->onDelete('cascade'); // معرف المورد (اختياري)
