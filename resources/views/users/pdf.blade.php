...
<body>
    <x-report-header title="User Report" subtitle="Complete list of users and their information" />
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="phone-column">
                                @if ($user->phone && $user->phone->count())
                            ...
                            <td class="address-column">{{ $user->address ?? 'N/A' }}</td>
                            <td class="role-column">
                                @if ($user->role && $user->role->count())
                            ...
                            <td class="date-column">{{ $user->created_at->format('Y-m-d') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
